...
public class UrlUtility {
	...
	*/
	...
	/**
	   * This method adds time in minutes to the date supplied, and returns the updated date/time.
	   *
	   * @param Date Date/time to which the minutes will be added.
	   * @param int Number of minutes to be added.
	   * @return Date Updated Date/time.
	*/
